                ...
                <div className="max-w-3xl mx-auto space-y-6">
                    {educationData.map((edu, index) => (
                        <motion.div
                            ...
                            className="flex items-center gap-6 p-6 rounded-2xl bg-dark-card border border-white/5 hover:border-white/20 transition-all group"
                        >
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-white group-hover:text-neon-blue transition-colors">{edu.degree}</h3>
                                <div className="text-gray-400 text-lg mb-1">{edu.school}</div>
