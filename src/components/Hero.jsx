            ...
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
                ...
                >
                    ...
                    <h2 className="text-xl md:text-2xl text-gray-300 mb-6 font-light">
                        WordPress Developer | AI Engineer | Platform & Operations Specialist
                    </h2>
                ...
                >
                    ...
                    <div className="relative w-80 h-80 md:w-96 md:h-96">
                        ...
                        <div className="absolute inset-8 rounded-full overflow-hidden border-4 border-white/10 shadow-[0_0_30px_rgba(0,243,255,0.2)] bg-dark-card flex items-center justify-center group">
                            ...
                            <img
                                src="https://placehold.co/400x400/1a1a2e/FFF?text=Aman"
                        ...
                        <motion.div
                            ...
                            className="absolute -top-4 -right-4 bg-dark-card border border-white/10 p-3 rounded-xl shadow-lg flex items-center gap-3 backdrop-blur-md"
                        >
                            <div className="w-10 h-10 bg-blue-500/20 rounded-full flex items-center justify-center text-blue-400 text-xl">WordPress</div>
                            <div>
                                <div className="text-xs text-gray-400">Experience</div>
                                <div className="font-bold text-sm">2.5+ Years</div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="absolute -bottom-4 -left-4 bg-dark-card border border-white/10 p-3 rounded-xl shadow-lg flex items-center gap-3 backdrop-blur-md"
                        >
                            <div className="w-10 h-10 bg-purple-500/20 rounded-full flex items-center justify-center text-purple-400">AI</div>
                            <div>
                                <div className="text-xs text-gray-400">Projects</div>
                                <div className="font-bold text-sm">20+ Delivered</div>
                            </div>
                        </motion.div>
                    </div>
                </motion.div>
